...
def home_view(request):
    ...
    for person in queryset:
        labels.append(person.bloodgroup)
        data.append(person.unit)

    return render(request,'blood/index.html',{'labels':labels,'data':data})
...
def Analytics(request):
    ...
    labels = []
    data = []
    info = models.BloodRequest.objects.all()
    for main in info:
        labels.append(main.bloodgroup)
        data.append(main.unit)
    return render(request,'blood/Analytics.html',{'labels':labels,'data':data})

def location(request):
    return render(request,'blood/location.html')

def info1(request):
    return render(request,'blood/info1.html')

def info2(request):
    return render(request,'blood/info2.html')

def info3(request):
    return render(request,'blood/info3.html')

def info4(request):
    return render(request,'blood/info4.html')